...
impl DbRace {
    ...
    pub async fn get_participants(&self, pool: &SqlitePool) -> sqlx::Result<Vec<DbRaceParticipant>> {
...
impl DbRaceParticipant {
    ...
    pub async fn insert(pool: &SqlitePool, race_id: i64, name: String, time: TimeDelta) -> sqlx::Result<Self> {
