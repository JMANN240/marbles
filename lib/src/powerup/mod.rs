...
use crate::{ball::Ball, powerup::{change_density::ChangeDensity, change_elasticity::ChangeElasticity, change_position::ChangePosition}, rendering::Render};
...
pub fn random_powerup(rng: &mut impl Rng, position: DVec2, viewport_width: f64, viewport_height: f64) -> Box<dyn Powerup> {
    let powerups: Vec<Box<dyn Powerup>> = vec![
        ...
        Box::new(ChangePosition::new(position, "Teleport", 8.0, 16.0..=(viewport_width - 16.0), 16.0..=(viewport_height - 16.0))),
    ];
